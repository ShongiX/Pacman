...
TexturedRectangle::TexturedRectangle(Menu *m, const std::string &fileName, const std::vector<GLfloat> &_vertices,
...
void TexturedRectangle::setTrans(const glm::mat4 &_trans) {
    TexturedRectangle::trans = _trans;
}
